...
# Plot the approximate posterior samples
hist(infection.rate, xlab= "Infection rate", main = "Posterior samples of Beta for stochastic SIR model")
hist(recovery.rate, xlab= "Recovery rate", main = "Posterior samples of Gamma for stochastic SIR model")
