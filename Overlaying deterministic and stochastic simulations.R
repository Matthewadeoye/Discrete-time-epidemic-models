...
# Empty plot frame
plot(0, type = "n", xlim = c(minTime, maxTime), ylim = c(0, 1), xlab = "Time", ylab = "Proportion", main = "Deterministic and stochastic discrete-time SIR simulations")
colors <- c("#add8e6", "#ffcccb", "#90ee90")
